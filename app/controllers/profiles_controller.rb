class ProfilesController < ApplicationController
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:all_tags, :name, :video_url, :representitive, :phone, :address, :category_id, :user_id, :facebook, :twitter, :instagram, :youtube, :linkedin, :description)
    end

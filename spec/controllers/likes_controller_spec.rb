...
RSpec.describe LikesController, type: :controller do
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved like as @like" do
        post :create, {:like => invalid_attributes}, valid_session
        expect(assigns(:like)).to be_a_new(Like)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        post = create(:post, :description => "custom description")
        {
          post_id: post.id
        }
      }
      ...
      it "updates the requested like" do
        like = Like.create! valid_attributes
        put :update, {:id => like.to_param, :like => new_attributes}, valid_session
        like.reload
        expect(like.post.description).to eq("custom description")
      end
    ...
    context "with invalid params" do
      it "assigns the like as @like" do
        like = Like.create! valid_attributes
        put :update, {:id => like.to_param, :like => invalid_attributes}, valid_session
        expect(assigns(:like)).to eq(like)
      end
